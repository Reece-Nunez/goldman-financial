...
export default function AddressAutocomplete({
  ...
  const inputClass = `w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#b8860b]/20 focus:border-[#b8860b] transition-colors bg-white text-gray-900 ${className}`;
